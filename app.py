...
Label(root, bg="#0f1a2b", image=Top).pack()

# logo

Logo = PhotoImage(file="logo.png")
Label(root, bg="#0f1a2b", image=Logo).place(x=65, y=115)
...
Button(root, text="Open Folder", width=15, height=2,
       font=("arial", 10, "bold"), fg="white", bg="#0f1a2b", command=open_folder).place(x=330, y=300)

scroll = Scrollbar(music_frame)
playlist = Listbox(music_frame, width=100, font=("arial", 10), bg="#0f1a2b", fg="grey",
